  ...
  return [
    ...
    } as Tool,
    {
      ...
      description:
        ...
        "Use this when the user says: 'open Agent Terminal', 'start a Codex terminal', 'launch Gemini', etc.",
      inputSchema: {
        type: "object" as const,
        properties: {
          agent: {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          reason: {
            type: "string",
            description:
              'What you will be teaching. Shown in the approval dialog as "Agent wants to guide you through {reason}". Keep it short and task-focused.',
          },
        },
        required: ["apps", "reason"],
      },
