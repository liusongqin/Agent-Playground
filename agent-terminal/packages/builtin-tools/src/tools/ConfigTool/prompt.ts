...
export const DESCRIPTION = 'Get or set Agent Terminal configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Agent Terminal configuration settings.

  View or change Agent Terminal settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
