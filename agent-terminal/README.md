...
牢 A (Anthropic) 官方 [Agent Terminal](https://docs.anthropic.com/en/docs/claude-code) CLI 工具的源码反编译/逆向还原项目。目标是将 Agent Terminal 大部分功能及工程化能力复现 (问就是老佛爷已经付过钱了)。虽然很难绷, 但是它叫做 CCB(踩踩背)... 而且, 我们实现了企业版或者需要登陆 Claude 账号才能使用的特性, 实现技术普惠
...
ccb # 以 nodejs 打开 Agent Terminal
ccb-bun # 以 bun 形态打开
...
本项目仅供学习研究用途。Agent Terminal 的所有权利归 [Anthropic](https://www.anthropic.com/) 所有。
