...
// Always ask when Agent Terminal tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Agent Terminal for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Agent Terminal)
