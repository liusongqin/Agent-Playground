...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Agent Terminal was first started on this machine
  ...
  // Agent Terminal usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Agent Terminal OAuth token
  ...
  // Agent Terminal hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
