...
const APP_NAME = 'Agent Terminal URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Agent Terminal URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Agent Terminal Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Agent Terminal
