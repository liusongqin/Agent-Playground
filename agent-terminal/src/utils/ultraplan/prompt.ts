...
const DEFAULT_DIALOG = {
  ...
  usageBlurb: ['Remote plan mode with rich web editing experience.', 'Runs in Agent Terminal on the web. When the plan is ready,', 'you can execute it in the web session or send it back here.', 'You can continue to work while the plan is generated remotely.'],
}
...
export const DIALOG_CONFIG = {
  ...
  three_subagents_with_critique: {
    ...
    usageBlurb: ['Advanced multi-agent plan mode.', 'Runs in Agent Terminal on the web. When the plan is ready,', 'you can execute it in the web session or send it back here.', 'You can continue to work while the plan is generated remotely.'],
  },
}
