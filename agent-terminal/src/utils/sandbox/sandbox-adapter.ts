...
/**
 * Resolve Agent Terminal-specific path patterns for sandbox-runtime.
 *
 * Agent Terminal uses special path prefixes in permission rules:
...
/**
 * Convert Agent Terminal settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Agent Terminal started)
