...
export function ResumeTask({
    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Box flexDirection="row">
          <Spinner />
          <Text bold>Loading Agent Terminal sessions…</Text>
        </Box>
        <Text dimColor>
          {retrying ? 'Retrying…' : 'Fetching your Agent Terminal sessions…'}
        </Text>
      </Box>
    )
  }
    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Text bold color="error">
          Error loading Agent Terminal sessions
        </Text>
  ...
  if (sessions.length === 0) {
    return (
      <Box flexDirection="column" padding={1}>
        <Text bold>
          No Agent Terminal sessions found
    ...
    case 'other':
      return (
        <Box marginY={1} flexDirection="row">
          <Text dimColor>Sorry, Agent Terminal encountered an error</Text>
        </Box>
      )
  }
}
