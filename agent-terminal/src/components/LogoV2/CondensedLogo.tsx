...
export function CondensedLogo(): ReactNode {
  ...
  // Truncate version to fit within available width, accounting for "Agent Terminal v" prefix
  const versionPrefix = 'Agent Terminal v'
