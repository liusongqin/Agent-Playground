  ...
  useEffect(() => {
    if (state.type === 'success') {
      ...
      setTimeout(
        onDone,
        2000,
        'Agent Terminal installation completed successfully',
        {
      ...
      setTimeout(onDone, 3000, 'Agent Terminal installation failed', {
        display: 'system' as const,
      })
    }
  }, [state, onDone])
  ...
  return (
    <Box flexDirection="column" marginTop={1}>
      ...
      {state.type === 'installing' && (
        <Text color="claude">
          Installing Agent Terminal native build {state.version}...
        </Text>
      )}
        ...
        <Box flexDirection="column" gap={1}>
          <Box>
            ...
            <Text color="success" bold>
              Agent Terminal successfully installed!
            </Text>
          </Box>
...
export const install = {
  ...
  name: 'install',
  description: 'Install Agent Terminal native build',
