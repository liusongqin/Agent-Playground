...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for Agent Terminal.\n' +
  '\n' +
  'Agent Terminal has an "auto mode" that uses an AI classifier to decide whether ' +
