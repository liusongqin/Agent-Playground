...
/**
 * Fetch the user's first Agent Terminal token date and store in config.
 * This is called after successful login to cache when they started using Agent Terminal.
 */
