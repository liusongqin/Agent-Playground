 ...
 * Initialized during Agent Terminal startup.
 */
 ...
 * asynchronously during Agent Terminal startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Agent Terminal startup. It synchronously creates
 ...
 *
 * This should be called during Agent Terminal shutdown. Stops all running LSP servers
