---
title: "为什么写这份白皮书 - Agent Terminal 逆向工程分析"
description: "对 Anthropic 官方 Agent Terminal CLI 的逆向工程分析白皮书。通过反编译 TypeScript 单文件 bundle，深入解析运行时行为与源码结构。"
keywords: ["Agent Terminal", "逆向工程", "白皮书", "反编译", "TypeScript"]
---

## 这份白皮书是什么

这是对 Anthropic 官方发布的 **Agent Terminal CLI** 的**逆向工程分析**。
...
AI 没有真正的"记忆"，Agent Terminal 通过精心分层营造了这个幻觉：
