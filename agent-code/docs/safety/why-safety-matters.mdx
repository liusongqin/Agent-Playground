---
title: "AI 安全至关重要 - Agent Code 安全设计哲学"
description: "当 AI 能操作你的真实项目文件和命令，安全的边界在哪里？分析 Agent Code 的安全挑战、威胁模型和纵深防御策略。"
keywords: ["AI 安全", "安全设计", "威胁模型", "纵深防御", "AI 风险"]
---

## AI 动手的代价

Agent Code 不是在沙盒里回答问题——它在你的真实项目中修改文件、执行命令。一个失误可能意味着：
...
Agent Code 的安全不是单一机制，而是**五层纵深防御**——任何一层失败，下一层仍然能阻止危险操作：
...
安全机制不是越多越好——每个额外检查都增加延迟、降低用户体验。Agent Code 的设计在两者间做了精细的权衡：
