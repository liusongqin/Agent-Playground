---
title: "架构全景 - Agent Code 五层架构详解"
description: "从交互层到基础设施层，详解 Agent Code 的五层架构设计。基于 src/main.tsx、src/QueryEngine.ts、src/query.ts、src/tools.ts、src/services/api/claude.ts 的源码级数据流分析。"
keywords: ["Agent Code 架构", "五层架构", "QueryEngine", "Agentic Loop", "数据流"]
---
...
Agent Code 从上到下分为五个层次，每一层职责清晰、边界分明：

<Frame caption="Agent Code 五层架构">
  <img src="/docs/images/architecture-layers.png" alt="Agent Code 五层架构图" />
</Frame>
...
<Frame caption="核心数据流">
  <img src="/docs/images/data-flow.png" alt="Agent Code 核心数据流" />
</Frame>
