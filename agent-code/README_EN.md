...
A reverse-engineered / decompiled source restoration of Anthropic's official [Agent Code](https://docs.anthropic.com/en/docs/claude-code) CLI tool. The goal is to reproduce most of Agent Code's functionality and engineering capabilities. It's abbreviated as CCB.
...
- Standard Agent Code configuration — each provider has its own setup method
...
This project is for educational and research purposes only. All rights to Agent Code belong to [Anthropic](https://www.anthropic.com/).
